...
export const NotSignedInView : FC = () =>{
    ...
    <div className="txt">A <span style={{color:"#f92"}}>no code</span> platform for artists,
    <br/>event organizers, businesses to<br/>create and sell NFT tickets with ease...</div>   
    </div>
